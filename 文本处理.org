...
*** 文本修改
    ...
    #+BEGIN_SRC python :session
      ...
      def shuffle(m):
          innter_word = list(m.group(2))
          random.shuffle(innter_word)
          return m.group(1) + ''.join(innter_word) + m.group(2)
    ...
    #+RESULTS[e2e9b145cff48df9b9031232ef1ed1a181e137ab]:
    :
    : >>> >>> >>> ... ... ... ... >>> >>> 'Poefrossrofesso Aaoellbmdbdolmale, pselaleas rrpeoepor yuoou anescebbsence pptmolrromptl.'
    : 'Peosrfosrofesso Abaolmldebdolmale, psaelleas rrpeoepor yuoou anbcseebsence proltmpromptl.'
...
** class difflib. *SequenceMatcher*
   ...
   #+RESULTS[89f7bb5fd93979bb842d279ec25234530a4a4882]:
   :
   : <class 'difflib.SequenceMatcher'>
