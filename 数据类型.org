...
* weakref - 弱引用
  ...
  就可以被回收，重用所占内存。但是，直到该对象被真正销毁前，即时没有强
  引用，弱引用也可返回该对象。
  
  弱引用的主要用途为实现对大型对象的缓存和映射。因为只需大型对象存在于
  缓存或映射中，不需保持存活。
...
*** class weakref. *ref* (object[,callback])
    ...
    #+BEGIN_SRC org
    - >>> >>> ... ... >>> ... ... >>> >>> >>> >>> True
    - >>> 2：弱引用对象：<weakref at 0x7f2a31754458; dead> 被删除
    - 1：弱引用对象：<weakref at 0x7f2a317544a8; dead> 被删除
    - 被引用对象不再存活后：
    - None None
    #+END_SRC
...
*** weakref. *getweakrefs* (obj)
    ...
    #+BEGIN_SRC org
    - >>> []
    - >>> [<weakref at 0x7f2a31754458; to 'set' at 0x7f2a31732e48>]
    - >>> [<weakref at 0x7f2a31754458; to 'set' at 0x7f2a31732e48>, <weakproxy at 0x7f2a317544a8 to set at 0x7f2a31732e48>]
    #+END_SRC
...
*** class weakref. *WeakKeyDictionary* ([dict])
    ...
    *注意* ：WeakKeyDictionary构建在普通字典基础上。在遍历时，有可能某
    ...
    #+RESULTS:
    #+BEGIN_SRC org
    - >>> ... >>> ... >>> >>> >>> [<function bar at 0x7f2a3103b598>]
    - >>> ... ... >>> ... >>> >>> >>> [<function bar at 0x7f2a3103b620>, <function foo at 0x7f2a3103b378>]
    #+END_SRC
...
*** class weakref. *WeakSet* ([elements])
    ...
    #+RESULTS:
    #+BEGIN_SRC org
    - >>> ... >>> ... >>> >>> >>> ... ... <function bar at 0x7f2a3103b6a8>
    - 不使用弱引用：
    - >>> ... >>> ... >>> >>> >>> ... ... <function bar at 0x7f2a3103b7b8>
    - <function foo at 0x7f2a3103b2f0>
    #+END_SRC
