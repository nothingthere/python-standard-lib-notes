...
**** codecs. *encode* (obj,encoding='utf-8',errors='strict')
     ...
     #+RESULTS[05a82eed7b61e35f8bfe65116be63b66c7520105]:
     :
     : b'ab\xe4\xb8\x80'
     : b'ab\xd2\xbb'
...
**** codecs. *decode* (obj,encoding='utf-8',errors='strict')
     ...
     #+RESULTS[19faa436d310b9ad7730c338dc8dc7e923d00ee4]:
     :
     : >>> 'ab一'
...
**** codecs. *lookup* (encoding)
     ...
     #+RESULTS[952bb37f890731b66892109abeaa85071c20f841]:
     :
...
***** *name*
      ...
      #+RESULTS[d4ead6089bb1f9edc97f3b766b86467c8ff04c8d]:
      :
      : >>> 'utf-8'
...
***** *decode*
      ...
      #+RESULTS[4b88049d6cbcb8aba6fb949f002f51bcadbfb4a3]:
      :
...
***** *incrementaldecoder*
      ...
      #+RESULTS[8391e38e5c37eacbb028470c5e687fa12975eeba]:
      :
...
***** codecs. *getencoder* (encoding)
      ...
      #+RESULTS[d489aebecd96a0ebc69128d9cee2c60db195145d]:
      :
      : >>> >>> (b'ab\xe4\xb8\x80', 3)
      : 'ab一'
...
***** codecs. *getdecoder* (encoding)
      ...
      #+RESULTS[eadf6c7d282bde562a1c226a6e5a56f45b4c0c62]:
      :
      : >>> ('一二三', 9)
...
***** codecs. *getincrementalencoder* (encoding)
      ...
      #+RESULTS[d968b3da24704235b943d8847c9f04cc0c08aead]:
      :
      : >>> <class 'encodings.utf_8.IncrementalEncoder'>
...
***** codecs. *getincrementaldecoder* (encoding)
      ...
      #+RESULTS[ffdb16df8d4776132cec17064385083a058cd5d8]:
      :
      : <class 'encodings.utf_8.IncrementalDecoder'>
...
***** codecs. *getreader* (encoding)
      ...
      #+RESULTS[ef4a738cb8a3175761cdc18e1a0bb46a7e733bb8]:
      :
...
***** codecs. *getwriter* (encoding)
      ...
      #+RESULTS[ad7685f5ddc8462c949530613d886fd36218c82b]:
      :
