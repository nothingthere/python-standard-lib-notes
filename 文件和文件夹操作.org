...
* stat - 解释stat()函数结果
  ...
  #+RESULTS:
  #+BEGIN_SRC org
  - >>> os.stat_result(st_mode=33188, st_ino=24779705, st_dev=2049, st_nlink=1, st_uid=1000, st_gid=1000, st_size=6, st_atime=1495439421, st_mtime=1495439408, st_ctime=1495439408)
  #+END_SRC
