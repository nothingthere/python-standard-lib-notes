...
**** rmtree. *avoid_symlink_attacks*
     ...
     #+BEGIN_SRC python :session
       import shutil
       shutil.rmtree.avoids_symlinks_attacks
     #+END_SRC
     ...
     - Traceback (most recent call last):
     -   File "<stdin>", line 1, in <module>
     - AttributeError: 'function' object has no attribute 'avoids_symlinks_attacks'
     #+END_SRC
...
*** shutil. *disk_usage* (path)
    ...
    #+BEGIN_SRC python :session
      import shutil
      shutil.disk_usage('/home/claudio/Documents')
    #+END_SRC

    #+RESULTS:
    #+BEGIN_SRC org
    - usage(total=488081694720, used=28461260800, free=434803576832)
    #+END_SRC
